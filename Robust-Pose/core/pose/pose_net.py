...
class PoseNet(nn.Module):
    ...
    def infer(self, image1l, image2l, intrinsics, baseline, depth1, image2r, mask1, mask2, stereo_flow1, ret_details=False):
        ...
        return self.infer_out(pose_head_ret, depth1, depth2, maps, time_flow, stereo_flow2, mask2, ret_details), time_flow_bwd, valid.unsqueeze(1), depth_r, valid_r.unsqueeze(1)
